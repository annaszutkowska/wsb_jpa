...
public class DoctorMapper {
    ...
    public static DoctorTO mapToTO(final DoctorEntity doctorEntity) {
        ...
        doctorTO.setAddress(AddressMapper.mapToTO(doctorEntity.getAddress())); // Assuming AddressMapper exists
        return doctorTO;
    }
    ...
    public static DoctorEntity mapToEntity(final DoctorTO doctorTO) {
        ...
        doctorEntity.setAddress(AddressMapper.mapToEntity(doctorTO.getAddress())); // Assuming AddressMapper exists
        return doctorEntity;
    }
}
